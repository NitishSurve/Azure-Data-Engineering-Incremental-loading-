...
# MAGIC )
# MAGIC USING csv
# MAGIC OPTIONS (path "/mnt/formula1dl2397/raw/circuits.csv", header true)
...
# MAGIC url STRING)
# MAGIC USING csv
# MAGIC OPTIONS (path "/mnt/formula1dl2397/raw/races.csv", header true)
...
# MAGIC url STRING)
# MAGIC USING json
# MAGIC OPTIONS(path "/mnt/formula1dl2397/raw/constructors.json")
...
# MAGIC url STRING)
# MAGIC USING json
# MAGIC OPTIONS (path "/mnt/formula1dl2397/raw/drivers.json")
...
# MAGIC USING json
# MAGIC OPTIONS(path "/mnt/formula1dl2397/raw/results.json")
...
# MAGIC time STRING)
# MAGIC USING json
# MAGIC OPTIONS(path "/mnt/formula1dl2397/raw/pit_stops.json", multiLine true)
...
# MAGIC )
# MAGIC USING csv
# MAGIC OPTIONS (path "/mnt/formula1dl2397/raw/lap_times")
...
# MAGIC raceId INT)
# MAGIC USING json
# MAGIC OPTIONS (path "/mnt/formula1dl2397/raw/qualifying", multiLine true)
...
# MAGIC %sql
# MAGIC DESC EXTENDED f1_raw.qualifying;
